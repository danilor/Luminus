<html>
<head>
    <!-- TAKEN FROM : http://codepen.io/silkine/pen/jldif -->
    ...
    <title>{{"FAQs"  }} - {{ $question->title }}</title>
...
<div class="head">
    ...
    <div class="subhead">{{ "Luminus" }} - {{ date("d/m/Y")  }} - {{ "Para tu propio conocimiento" }}</div>
</div>
<div class="content">
    <div class="collumns">
        <div class="collumn">
            <div class="head"><span class="headline hl3">{{ $question->title }}</span><p><span class="headline hl4">{{ "por FAQS -> PREGUNTAS Y RESPUESTAS"  }}</span></p></div>

            {!! $question -> getAnswerContent( $Module , true ) !!}
